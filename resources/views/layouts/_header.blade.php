...
<div class="bg-gray-800">
    <div class="2xl:max-w-screen-2xl xl:max-w-screen-xl mx-auto top-0 h-16 flex justify-between items-center px-4">
        <div class="w-auto">
                ...
                @if (Auth::check())
                    <div>
                        <button type="button" class="relative group">
                            <img class="h-9 w-9 rounded-full" src="{{ Auth::user()->gravatar('36') }}" alt="">
